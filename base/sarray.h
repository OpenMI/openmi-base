 ...
 *
 *  Statement: This file COPY from the ps-lite project of DMLC. 
 *  url: https://github.com/dmlc/ps-lite/blob/master/include/ps/sarray.h
 */
#ifndef OPENMI_BASE_SARRAY_H_
#define OPENMI_BASE_SARRAY_H_
#include <string.h>
#include <string>
#include <vector>
#include <memory>
